...
import { FiPhoneCall, FiCalendar, FiPlusCircle } from "react-icons/fi";
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center sm:gap-2">
        ...
        <h5 className="text-[10px] sm:text-base font-bold mt-1 sm:mt-0">
          {title}
        </h5>
      </div>
...
const ServiceList = () => {
  return (
    <div
      className="absolute top-[20] left-0 w-full flex justify-center sm:justify-start 
    ...
    >
      ...
      <ServiceCard
        icon={<FiPlusCircle />}
        title=" Chuyên khoa"
        description="Chọn theo chuyên khoa"
